...
( set -x ; OUT_DIR="$OUT_DIR" DIST_DIR="$DIST_DIR" BUILD_NUMBER="$BNUM" ../../gradlew --project-dir ../.. $GRADLE_FLAGS :sdk:eclipse:copydeps buildEclipse ) || exit $?
...
( set -x ; OUT_DIR="$OUT_DIR" DIST_DIR="$DIST_DIR" BUILD_NUMBER="$BNUM" ../../gradlew --project-dir ../.. $GRADLE_FLAGS $TARGET ) || exit $?
